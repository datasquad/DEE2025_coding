...
* [natural.xlsx](https://github.com/datasquad/DEE2025_coding/blob/master/natural.xlsx), this contains data on natural disasters. The data come from the [The Centre for Research on the Epidemiology of Disasters (CRED)](https://www.emdat.be/)
* [EDGAR_AR5_GHG_1970_2023.xlsx](https://github.com/datasquad/DEE2025_coding/blob/master/EDGAR_AR5_GHG_1970_2023.xlsx), this contains greenhouse gas emissions by country and year. This is the 2024 version of the [EDGAR dataset](https://edgar.jrc.ec.europa.eu/dataset_ghg2024) maintained by the European Union.
* [WorldBank_population.csv](https://github.com/datasquad/DEE2025_coding/blob/master/WorldBank_population.csv), this is a file with the population for countries through time. The data come from the World Bank.