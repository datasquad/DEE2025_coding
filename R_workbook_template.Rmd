...
What is the formula that translates temperatures in Celsius to temperatures in Fahrenheit?

```{r, echo = FALSE}
opts_p <- c(
   "degree Fahrenheit temperatures cannot be translated to degree Celsius",
   answer = "dF = 1.8 * dC + 32",
   "dF = 1.6 * dC + 32",
   "dC = 1.8 * dF + 32",
   "dC = 1.6 * dF + 32"
